...
import yolung.cardinalblue.com.mvp_pattern.Injection;
import yolung.cardinalblue.com.mvp_pattern.R;
//import yolung.cardinalblue.com.mvp_pattern.Injection;
import yolung.cardinalblue.com.mvp_pattern.util.EspressoIdlingResource;
...
public class AddNoteFragment extends Fragment implements AddNoteContract.View {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFab = (FloatingActionButton) getActivity().findViewById(R.id.fab_add_notes);
        ...
        mDisposables.add(
            RxView
                ...
                .map(new Function<Object, String[]>() {
                    @Override
                    public String[] apply(@NonNull Object ignored)
                        throws Exception {
                        return new String[] {
                ...
                .flatMap(new Function<String[], ObservableSource<?>>() {
                    @Override
                    public ObservableSource<?> apply(@NonNull String[] ss)
                        throws Exception {
                        return mActionListener.saveNote(ss[0], ss[1]);
                    }
                })
                .subscribe());
    }
